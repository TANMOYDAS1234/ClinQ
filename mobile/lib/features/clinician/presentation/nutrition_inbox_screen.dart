                  ...
                  children: [
                    ...
                    async.when(
                      ...
                      data: (paged) {
                        ...
                        // One grouped card with hairline dividers, matching the
                        // Patients inbox, so the two tabs read as one product.
                        return Container(
                          ...
                          child: Column(
                            children: [
                              for (var i = 0; i < items.length; i++) ...[
                                ...
                                _ConversationRow(
                                  session: items[i],
                                  onTap: () => context.push('/clinician/chat-review/${items[i].id}'),
                                ),
                              ],
                            ],
                          ),
